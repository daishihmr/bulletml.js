...
a=d.length;a--;)d[a].parentTicker=f;f.compChildCount=0;f.completeChild=function(){this.compChildCount++};f.restart=function(){for(var a=d.length;a--;)d[a].restart();this.compChildCount=0;this.complete=!1};f.restart();f.isDanmaku=!0;return f}return this._createTicker(c,e)},_createTicker:function(c,e){c=this._getConf(c);if(!c.target)throw Error("not set target in config.");var d=this,a=function(){this.age<a.chDirEnd?a.direction+=a.dirIncr:this.age==a.chDirEnd&&(a.direction=a.dirFin);this.age<a.chSpdEnd?
a.speed+=a.spdIncr:this.age==a.chSpdEnd&&(a.speed=a.spdFin);this.age<a.aclEnd?(a.speedH+=a.aclIncrH,a.speedV+=a.aclIncrV):this.age==a.aclEnd&&(a.speedH=a.aclFinH,a.speedV=a.aclFinV);this.x+=Math.cos(a.direction)*a.speed*c.speedRate;this.y+=Math.sin(a.direction)*a.speed*c.speedRate;this.x+=a.speedH*c.speedRate;this.y+=a.speedV*c.speedRate;c.testInWorld(this)||this.parentNode.removeChild(this);c.updateProperties&&(this.direction=180*(a.direction+Math.PI/2)/Math.PI,this.speed=a.speed);if(!(this.age<
a.waitTo||a.completed)){for(var e;e=a.walker.next();)switch(e.commandName){case "fire":d._fire.call(this,e,c,a,d);break;case "wait":a.waitTo=this.age+eval(e.value);return;case "changeDirection":d._changeDirection.call(this,e,c,a);break;case "changeSpeed":d._changeSpeed.call(this,e,a);break;case "accel":d._accel.call(this,e,a);break;case "vanish":this.parentNode&&this.parentNode.removeChild(this)}a.completed=!0;a.parentTicker?a.parentTicker.completeChild():this.dispatchEvent(new Event("completeAttack"))}};
a.restart=function(){if(void 0===e)this.walker=d._bulletml.getWalker("top",c.rank);else if("string"===typeof e)this.walker=d._bulletml.getWalker(e,c.rank);else if(e instanceof BulletML.Bullet)this.walker=e.getWalker(c.rank);else throw Error("\u5f15\u6570\u304c\u4e0d\u6b63",c,e);this.waitTo=-1;this.completed=!1;this.dirFin=this.dirIncr=this.speedV=this.speedH=this.lastSpeed=this.speed=this.lastDirection=this.direction=0;this.chDirEnd=-1;this.spdFin=this.spdIncr=0;this.chSpdEnd=-1;this.aclFinV=this.aclIncrV=
this.aclFinH=this.aclIncrH=0;this.aclEnd=-1};a.restart();a.isDanmaku=!0;return a},_fire:function(c,e,d,a){var f=e.bulletFactory({label:c.bullet.label});if(f){var j=a.createTicker(e,c.bullet),k=this;j.direction=function(a){var b=h(eval(a.value));switch(a.type){case "aim":return e.target?n(k,e.target)+b:b-Math.PI/2;case "absolute":return b-Math.PI/2;case "relative":return d.direction+b;case "sequence":return d.lastDirection+b}}(c.direction||c.bullet.direction);d.lastDirection=j.direction;j.speed=function(a){var b=
eval(a.value);switch(a.type){case "relative":case "sequence":return d.lastSpeed+b;default:return b}}(c.speed||c.bullet.speed);d.lastSpeed=j.speed;f.x=this.x+((this.width||0)-(f.width||0))/2;f.y=this.y+((this.height||0)-(f.height||0))/2;f.addEventListener("enterframe",j);f.addEventListener("removed",function(){this.removeEventListener("enterframe",j)});e.addTarget?e.addTarget.addChild(f):this.parentNode&&this.parentNode.addChild(f)}},_changeDirection:function(c,e,d){var a=eval(c.direction.value),f=
eval(c.term);switch(c.direction.type){case "aim":c=e.target;if(!c)return;d.dirFin=n(this,c)+h(a);d.dirIncr=m(d.dirFin-d.direction)/f;break;case "absolute":d.dirFin=h(a)-Math.PI/2;d.dirIncr=m(d.dirFin-d.direction)/f;break;case "relative":d.dirFin=d.direction+h(a);d.dirIncr=m(d.dirFin-d.direction)/f;break;case "sequence":d.dirIncr=h(a),d.dirFin=d.direction+d.dirIncr*f}d.chDirEnd=this.age+f},_changeSpeed:function(c,e){var d=eval(c.speed.value),a=eval(c.term);switch(c.speed.type){case "absolute":e.spdFin=
d;e.spdIncr=(e.spdFin-e.speed)/a;break;case "relative":e.spdFin=d+e.speed;e.spdIncr=(e.spdFin-e.speed)/a;break;case "sequence":e.spdIncr=d,e.spdFin=e.speed+e.spdIncr*a}e.chSpdEnd=this.age+a},_accel:function(c,e){var d=eval(c.term);e.aclEnd=this.age+d;if(c.horizontal){var a=eval(c.horizontal.value);switch(c.horizontal.type){case "absolute":case "sequence":e.aclIncrH=(a-e.speedH)/d;e.aclFinH=a;break;case "relative":e.aclIncrH=a,e.aclFinH=(a-e.speedH)*d}}else e.aclIncrH=0,e.aclFinH=e.speedH;if(c.vertical)switch(a=
