...
c),a=new bulletml.Action;a.root=this.root;a.commands=this.actions;c._action=a;c._localScope=this._localScope;return c}})();(function(){function c(b){var c=new bulletml.Root;if(b=b.getElementsByTagName("bulletml")[0]){l(b,"type",function(a){c.type=a});var f=b.getElementsByTagName("action");if(f)for(var h=0,n=f.length;h<n;h++)if(f[h].parentNode===b){var g=a(c,f[h]);g&&(c.actions[c.actions.length]=g)}if(f=b.getElementsByTagName("bullet")){h=0;for(n=f.length;h<n;h++)f[h].parentNode===b&&(g=d(c,f[h]))&&(c.bullets[c.bullets.length]=g)}if(f=b.getElementsByTagName("fire")){h=0;for(n=f.length;h<n;h++)f[h].parentNode===b&&(g=e(c,
f[h]))&&(c.fires[c.fires.length]=g)}return c}}function a(c,d){var f=new bulletml.Action;l(d,"label",function(a){f.label=a});p(d,".",function(h){switch(h.tagName.toLowerCase()){case "action":f.commands[f.commands.length]=a(c,h);break;case "actionref":f.commands[f.commands.length]=b(c,h);break;case "fire":f.commands[f.commands.length]=e(c,h);break;case "fireref":var d=f.commands,j=f.commands.length,m=new bulletml.FireRef;l(h,"label",function(a){m.label=a});p(h,/param$/,function(a){m.params[m.params.length]=
k(a)});m.root=c;d[j]=m;break;case "changedirection":var d=f.commands,j=f.commands.length,s=new bulletml.ChangeDirection;s.root=c;i(h,"direction",function(a){s.direction=g(new bulletml.Direction,a)});i(h,"term",function(a){s.term=k(a)});d[j]=s;break;case "changespeed":var d=f.commands,j=f.commands.length,t=new bulletml.ChangeSpeed;t.root=c;i(h,"speed",function(a){t.speed=g(new bulletml.Speed,a)});i(h,"term",function(a){t.term=k(a)});d[j]=t;break;case "accel":var d=f.commands,j=f.commands.length,q=
new bulletml.Accel;q.root=c;i(h,"horizontal",function(a){q.horizontal=g(new bulletml.Horizontal,a)});i(h,"vertical",function(a){q.vertical=g(new bulletml.Vertical,a)});i(h,"term",function(a){q.term=k(a)});d[j]=q;break;case "wait":var d=f.commands,j=f.commands.length,u=new bulletml.Wait;u.root=c;u.value=k(h);d[j]=u;break;case "vanish":h=f.commands;d=f.commands.length;j=new bulletml.Vanish;j.root=c;h[d]=j;break;case "repeat":var d=f.commands,j=f.commands.length,r=new bulletml.Repeat;i(h,"action",function(b){r.action=
a(c,b)});i(h,"actionRef",function(a){r.action=b(c,a)});i(h,"times",function(a){r.times=k(a)});r.root=c;d[j]=r}});f.root=c;return f}function b(a,b){var c=new bulletml.ActionRef;l(b,"label",function(a){c.label=a});p(b,/param$/,function(a){c.params[c.params.length]=k(a)});c.root=a;return c}function d(c,d){var f=new bulletml.Bullet;l(d,"label",function(a){f.label=a});i(d,"direction",function(a){f.direction=g(new bulletml.Direction,a)});i(d,"speed",function(a){f.speed=g(new bulletml.Speed,a)});p(d,/(action)|(actionRef)$/,
function(d){"action"==d.tagName.toLowerCase()?f.actions[f.actions.length]=a(c,d):"actionref"==d.tagName.toLowerCase()&&(f.actions[f.actions.length]=b(c,d))});f.root=c;return f}function e(a,b){var c=new bulletml.Fire;l(b,"label",function(a){c.label=a});i(b,"direction",function(a){c.direction=g(new bulletml.Direction,a)});i(b,"speed",function(a){c.speed=g(new bulletml.Speed,a)});i(b,"bullet",function(b){c.bullet=d(a,b)});i(b,"bulletref",function(b){var d=new bulletml.BulletRef;l(b,"label",function(a){d.label=
a});p(b,/param$/,function(a){d.params[d.params.length]=k(a)});d.root=a;c.bullet=d});if(!c.bullet)throw Error("fire has no bullet or bulletRef.");c.root=a;return c}function g(a,b){l(b,"type",function(b){a.type=b});k(b,function(b){a.value=b});return a}function i(a,b,c,d){for(var b=b.toLowerCase(),a=a.childNodes,e=0,g=a.length;e<g;e++)if(a[e].tagName&&a[e].tagName.toLowerCase()==b)return c&&c(a[e]),a[e];d&&d();return null}function p(a,b,c){for(var a=a.childNodes,d=0,e=a.length;d<e;d++)a[d].tagName&&
a[d].tagName.toLowerCase().match(b)&&c(a[d])}function l(a,b,c,d){if(a=a.attributes[b])return c&&c(a.value),a;d&&d()}function k(a,b){var c=a.textContent.trim();if(void 0!==c)return b&&b(c),c;if(a.childNodes[0]&&(c=a.childNodes[0].nodeValue,void 0!==c))return b&&b(c),c}bulletml.build=function(a){if("string"===typeof a)var b=new DOMParser,a=c(b.parseFromString(a,"application/xml"));else if(a.getElementsByTagName("bulletml"))a=c(a);else throw Error("cannot build "+a);return a}})();(function(){bulletml.dsl=function(c){var c=c||"",a;for(a in bulletml.dsl)bulletml.dsl.hasOwnProperty(a)&&(bulletml.GLOBAL[c+a]=bulletml.dsl[a])};bulletml.dsl.action=function(c){if(0<arguments.length)for(var a=0,b=arguments.length;a<b;a++)arguments[a]instanceof Function&&(arguments[a]=arguments[a]());if(c instanceof Array){a=0;for(b=c.length;a<b;a++)c[a]instanceof Function&&(c[a]=c[a]())}var d=new bulletml.Action;if(c instanceof Array){if(c.some(function(a){return!(a instanceof bulletml.Command)}))throw Error("argument type error.");
...
bulletml.dsl.bullet=function(c,a,b,d){for(var e=0,g=arguments.length;e<g;e++)arguments[e]instanceof Function&&(arguments[e]=arguments[e]());g=new bulletml.Bullet;for(e=0;e<arguments.length;e++)arguments[e]instanceof bulletml.Direction?g.direction=arguments[e]:arguments[e]instanceof bulletml.Speed?g.speed=arguments[e]:arguments[e]instanceof bulletml.Action?g.actions.push(arguments[e]):arguments[e]instanceof bulletml.ActionRef?g.actions.push(arguments[e]):arguments[e]instanceof Array?g.actions.push(bulletml.dsl.action(arguments[e])):
arguments[e]instanceof Object?g.option=arguments[e]:"string"===typeof arguments[e]&&(g.label=arguments[e]);return g};bulletml.dsl.bulletRef=function(c,a){for(var b=0,d=arguments.length;b<d;b++)arguments[b]instanceof Function&&(arguments[b]=arguments[b]());if(void 0===c)throw Error("label is required.");d=new bulletml.BulletRef;d.label=""+c;if(a instanceof Array)d.params=a;else for(b=1;b<arguments.length;b++)d.params.push(arguments[b]);return d};bulletml.dsl.fire=function(c,a,b,d){for(var e=0,g=arguments.length;e<
...
arguments[e]instanceof bulletml.OffsetY?g.option.offsetY=arguments[e].value:arguments[e]instanceof bulletml.Autonomy&&(g.option.autonomy=arguments[e].value);if(void 0===g.bullet)throw Error("bullet (or bulletRef) is required.");return g};bulletml.dsl.fireRef=function(c,a){for(var b=0,d=arguments.length;b<d;b++)arguments[b]instanceof Function&&(arguments[b]=arguments[b]());if(void 0===c)throw Error("label is required.");d=new bulletml.FireRef;d.label=""+c;if(a instanceof Array)d.params=a;else for(b=
