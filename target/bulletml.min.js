...
(c[b]=this._localScope[b]);return c};bulletml.Root.prototype.getWalker=function(c){var b=new bulletml.Walker(this);if(c=this.findAction(c))b._action=c;return b};bulletml.Bullet.prototype.getWalker=function(){var c=new bulletml.Walker(this.root),b=new bulletml.Action;b.root=this.root;b.commands=this.actions;c._action=b;c._localScope=this._localScope;return c};bulletml.Walker.globalScope={}})();(function(){function c(a){var c=new bulletml.Root;if(a=a.getElementsByTagName("bulletml")[0]){l(a,"type",function(a){c.type=a});var d=a.getElementsByTagName("action");if(d)for(var h=0,p=d.length;h<p;h++)if(d[h].parentNode===a){var g=b(c,d[h]);g&&(c.actions[c.actions.length]=g)}if(d=a.getElementsByTagName("bullet"))for(h=0,p=d.length;h<p;h++)d[h].parentNode===a&&(g=e(c,d[h]))&&(c.bullets[c.bullets.length]=g);if(d=a.getElementsByTagName("fire"))for(h=0,p=d.length;h<p;h++)d[h].parentNode===a&&(g=f(c,
d[h]))&&(c.fires[c.fires.length]=g);return c}}function b(c,d){var e=new bulletml.Action;l(d,"label",function(a){e.label=a});q(d,".",function(d){switch(d.tagName.toLowerCase()){case "action":e.commands[e.commands.length]=b(c,d);break;case "actionref":e.commands[e.commands.length]=a(c,d);break;case "fire":e.commands[e.commands.length]=f(c,d);break;case "fireref":e.commands[e.commands.length]=m(c,d);break;case "changedirection":e.commands[e.commands.length]=k(c,d);break;case "changespeed":e.commands[e.commands.length]=
r(c,d);break;case "accel":e.commands[e.commands.length]=w(c,d);break;case "wait":var t=e.commands,g=e.commands.length,l=new bulletml.Wait;l.root=c;l.value=n(d);t[g]=l;break;case "vanish":d=e.commands;t=e.commands.length;g=new bulletml.Vanish;g.root=c;d[t]=g;break;case "repeat":e.commands[e.commands.length]=x(c,d)}});e.root=c;return e}function a(a,b){var c=new bulletml.ActionRef(l(b,"label"));q(b,/param$/,function(a){c.params[c.params.length]=n(a)});c.root=a;return c}function e(c,d){var e=new bulletml.Bullet;
l(d,"label",function(a){e.label=a});g(d,"direction",function(a){e.direction=u(a)});g(d,"speed",function(a){e.speed=v(a)});q(d,/(action)|(actionRef)$/,function(d){"action"==d.tagName.toLowerCase()?e.actions[e.actions.length]=b(c,d):"actionref"==d.tagName.toLowerCase()&&(e.actions[e.actions.length]=a(c,d))});e.root=c;return e}function d(a,b){var c=new bulletml.BulletRef(l(b,"label"));q(b,/param$/,function(a){c.params[c.params.length]=n(a)});c.root=a;return c}function f(a,b){var c=new bulletml.Fire;
l(b,"label",function(a){c.label=a});g(b,"direction",function(a){c.direction=u(a)});g(b,"speed",function(a){c.speed=v(a)});g(b,"bullet",function(b){c.bullet=e(a,b)});g(b,"bulletref",function(b){c.bullet=d(a,b)});if(!c.bullet)throw Error("fire has no bullet or bulletRef.");c.root=a;return c}function m(a,b){var c=new bulletml.FireRef(l(b,"label"));q(b,/param$/,function(a){c.params[c.params.length]=n(a)});c.root=a;return c}function k(a,b){var c=new bulletml.ChangeDirection;c.root=a;g(b,"direction",function(a){c.direction=
u(a)});g(b,"term",function(a){c.term=n(a)});return c}function r(a,b){var c=new bulletml.ChangeSpeed;c.root=a;g(b,"speed",function(a){c.speed=v(a)});g(b,"term",function(a){c.term=n(a)});return c}function w(a,b){var c=new bulletml.Accel;c.root=a;g(b,"horizontal",function(a){a=s(new bulletml.Horizontal,a);c.horizontal=a});g(b,"vertical",function(a){a=s(new bulletml.Vertical,a);c.vertical=a});g(b,"term",function(a){c.term=n(a)});return c}function x(c,d){var e=new bulletml.Repeat;g(d,"action",function(a){e.action=
b(c,a)});g(d,"actionRef",function(b){e.action=a(c,b)});g(d,"times",function(a){e.times=n(a)});e.root=c;return e}function u(a){return s(new bulletml.Direction,a)}function v(a){return s(new bulletml.Speed,a)}function s(a,b){l(b,"type",function(b){a.type=b});n(b,function(b){a.value=b});return a}function g(a,b,c,d){b=b.toLowerCase();a=a.childNodes;for(var e=0,f=a.length;e<f;e++)if(a[e].tagName&&a[e].tagName.toLowerCase()==b)return c&&c(a[e]),a[e];d&&d();return null}function q(a,b,c){a=a.childNodes;for(var d=
0,e=a.length;d<e;d++)a[d].tagName&&a[d].tagName.toLowerCase().match(b)&&c(a[d])}function l(a,b,c,d){if(a=a.attributes[b])return c&&c(a.value),a.value;d&&d();return""}function n(a,b){var c=a.textContent.trim();return void 0!==c?(b&&b(c),c):""}bulletml.build=function(a){if("string"===typeof a){var b=new DOMParser;a=c(b.parseFromString(a,"application/xml"))}else if(a.getElementsByTagName("bulletml"))a=c(a);else throw Error("cannot build "+a);return a}})();(function(){bulletml.dsl=function(c){c=c||"";for(var b in bulletml.dsl)bulletml.dsl.hasOwnProperty(b)&&(bulletml.GLOBAL[c+b]=bulletml.dsl[b])};bulletml.dsl.action=function(c){if(0<arguments.length)for(var b=0,a=arguments.length;b<a;b++)arguments[b]instanceof Function&&(arguments[b]=arguments[b]());if(c instanceof Array)for(b=0,a=c.length;b<a;b++)c[b]instanceof Function&&(c[b]=c[b]());var e=new bulletml.Action;if(c instanceof Array){if(c.some(function(a){return!(a instanceof bulletml.Command)}))throw Error("argument type error.");
...
b&&(a.type=b);return a};bulletml.dsl.fireOption=function(c){return new bulletml.FireOption(c)};bulletml.dsl.offsetX=function(c){return new bulletml.OffsetX(c)};bulletml.dsl.offsetY=function(c){return new bulletml.OffsetY(c)};bulletml.dsl.autonomy=function(c){return new bulletml.Autonomy(c)}})();(function(){bulletml.runner=bulletml.runner||{};bulletml.runner.Bullet=function(){this.y=this.x=0};bulletml.runner.Bullet.prototype.vanish=function(){};bulletml.runner.Bullet.prototype.notify=function(a,b){};bulletml.runner.RunnerFactory=function(a){this.root=a};bulletml.runner.RunnerFactory.prototype.create=function(a,b){for(var c in bulletml.runner.DEFAULT_CONFIG)bulletml.runner.DEFAULT_CONFIG.hasOwnProperty(c)&&void 0===b[c]&&(b[c]=bulletml.runner.DEFAULT_CONFIG[c]);c=this.root.getTopActionLabels();
if(1===c.length)return new bulletml.runner.SubRunner(a,b,this.root.getWalker(c[0]));for(var f=new bulletml.runner.ParentRunner,m=0,k=c.length;m<k;m++)f.addSubRunner(new bulletml.runner.SubRunner(a,b,this.root.getWalker(c[m])));return f};bulletml.Root.prototype.startAttack=function(a,b,c){var f=new bulletml.runner.Bullet;f.x=a.x;f.y=a.y;a=(new bulletml.runner.RunnerFactory(this)).create(f,b);c&&c(f,a);return a};bulletml.runner.DEFAULT_CONFIG={rank:0,target:null,createNewBullet:function(a,b){}};bulletml.runner.Runner=
function(){};bulletml.runner.Runner.prototype={constructor:bulletml.runner.Runner,update:function(){}};bulletml.runner.ParentRunner=function(){bulletml.runner.Runner.call(this);this.completed=!1;this.completedChildCount=0;this.subRunners=[]};bulletml.runner.ParentRunner.prototype=Object.create(bulletml.runner.Runner.prototype);bulletml.runner.ParentRunner.prototype.addSubRunner=function(a){a.parentRunner=this;this.subRunners.push(a)};bulletml.runner.ParentRunner.prototype.update=function(){for(var a=
this.subRunners.length;a--;)this.subRunners[a].update();this.completedChildCount===this.subRunners.length&&(this.completed=!0)};bulletml.runner.SimpleSubRunner=function(a,b){bulletml.runner.Runner.call(this);this.attacker=a;this.config=b;this.speed=this.direction=0;this.deltaY=this.deltaX=null};bulletml.runner.SimpleSubRunner.prototype=Object.create(bulletml.runner.Runner.prototype);bulletml.runner.SimpleSubRunner.prototype.update=function(){null===this.deltaX&&(this.deltaX=Math.cos(this.direction)*
this.speed);null===this.deltaY&&(this.deltaY=Math.sin(this.direction)*this.speed);this.attacker.x+=this.deltaX;this.attacker.y+=this.deltaY};bulletml.runner.SubRunner=function(a,b,c){bulletml.runner.SimpleSubRunner.call(this,a,b);this.walker=c;this.waitTo=-1;this.dirFin=this.dirIncr=this.speedV=this.speedH=this.lastSpeed=this.lastDirection=0;this.chDirEnd=-1;this.spdFin=this.spdIncr=0;this.chSpdEnd=-1;this.aclFinV=this.aclIncrV=this.aclFinH=this.aclIncrH=0;this.age=this.aclEnd=-1;this.stop=!1;this.parentRunner=
null};bulletml.runner.SubRunner.prototype=Object.create(bulletml.runner.SimpleSubRunner.prototype);bulletml.runner.SubRunner.prototype.update=function(){if(!(this.stop||(this.age+=1,this.age<this.chDirEnd?this.direction+=this.dirIncr:this.age===this.chDirEnd&&(this.direction=this.dirFin),this.age<this.chSpdEnd?this.speed+=this.spdIncr:this.age===this.chSpdEnd&&(this.speed=this.spdFin),this.age<this.aclEnd?(this.speedH+=this.aclIncrH,this.speedV+=this.aclIncrV):this.age===this.aclEnd&&(this.speedH=
this.aclFinH,this.speedV=this.aclFinV),this.attacker.x+=Math.cos(this.direction)*this.speed,this.attacker.y+=Math.sin(this.direction)*this.speed,this.attacker.x+=this.speedH,this.attacker.y+=this.speedV,this.age<this.waitTo||this.completed))){for(var a;a=this.walker.next();)switch(a.commandName){case "fire":this.fire(a);break;case "wait":this.waitTo=this.age+a.value;return;case "changeDirection":this.changeDirection(a);break;case "changeSpeed":this.changeSpeed(a);break;case "accel":this.accel(a);
break;case "vanish":this.attacker.vanish();break;case "notify":this.notify(a)}this.completed=!0;null!==this.parentRunner&&(this.parentRunner.completedChildCount+=1)}};bulletml.runner.SubRunner.prototype.fire=function(a){var c=new bulletml.runner.Bullet,d;d=0===a.bullet.actions.length?new bulletml.runner.SimpleSubRunner(c,this.config):new bulletml.runner.SubRunner(c,this.config,a.bullet.getWalker());var f={x:this.attacker.x+a.option.offsetX,y:this.attacker.y+a.option.offsetY},m=a.direction||a.bullet.direction,
k=m.value*Math.PI/180;switch(m.type){case "aim":d.direction=this.config.target?a.option.autonomy?b(f,this.config.target)+k:b(this.attacker,this.config.target)+k:k-Math.PI/2;break;case "absolute":d.direction=k-Math.PI/2;break;case "relative":d.direction=this.direction+k;break;default:d.direction=this.lastDirection+k}this.lastDirection=d.direction;m=a.speed||a.bullet.speed;k=m.value;switch(m.type){case "relative":d.speed=this.speed+k;break;case "sequence":d.speed=this.lastSpeed+k;break;default:d.speed=
k}this.lastSpeed=d.speed;c.x=f.x;c.y=f.y;var f={},r;for(r in a.bullet.option)f[r]=a.bullet.option[r];f.label=a.bullet.label;this.config.createNewBullet(c,d,f)};bulletml.runner.SubRunner.prototype.changeDirection=function(a){var e=a.direction.value*Math.PI/180,d=a.term;switch(a.direction.type){case "aim":this.dirFin=b(this.attacker,this.config.target)+e;this.dirIncr=c(this.dirFin-this.direction)/d;break;case "absolute":this.dirFin=e-Math.PI/2;this.dirIncr=c(this.dirFin-this.direction)/d;break;case "relative":this.dirFin=
this.direction+e;this.dirIncr=c(this.dirFin-this.direction)/d;break;case "sequence":this.dirIncr=e,this.dirFin=this.direction+this.dirIncr*(d-1)}this.chDirEnd=this.age+d};bulletml.runner.SubRunner.prototype.changeSpeed=function(a){var b=a.speed.value,c=a.term;switch(a.speed.type){case "absolute":this.spdFin=b;this.spdIncr=(this.spdFin-this.speed)/c;break;case "relative":this.spdFin=b+this.speed;this.spdIncr=(this.spdFin-this.speed)/c;break;case "sequence":this.spdIncr=b,this.spdFin=this.speed+this.spdIncr*
c}this.chSpdEnd=this.age+c};bulletml.runner.SubRunner.prototype.accel=function(a){var b=a.term;this.aclEnd=this.age+b;if(a.horizontal){var c=a.horizontal.value;switch(a.horizontal.type){case "absolute":case "sequence":this.aclIncrH=(c-this.speedH)/b;this.aclFinH=c;break;case "relative":this.aclIncrH=c,this.aclFinH=(c-this.speedH)*b}}else this.aclIncrH=0,this.aclFinH=this.speedH;if(a.vertical)switch(c=a.vertical.value,a.vertical.type){case "absolute":case "sequence":this.aclIncrV=(c-this.speedV)/b;
this.aclFinV=c;break;case "relative":this.aclIncrV=c,this.aclFinV=(c-this.speedV)*b}else this.aclIncrV=0,this.aclFinV=this.speedV};bulletml.runner.SubRunner.prototype.notify=function(a){this.attacker.notify(a.eventName,a.params)};var c=function(a){for(;a<=-Math.PI;)a+=2*Math.PI;for(;Math.PI<a;)a-=2*Math.PI;return a},b=function(a,b){return Math.atan2(b.y-a.y,b.x-a.x)}})();
