...
cp src/main/bulletml.enchant.js target/bulletml.enchant-$2.js

java -jar build-tools/compiler-latest/compiler.jar --js=src/main/bulletml.js --js_output_file=target/bulletml-min.js
java -jar build-tools/compiler-latest/compiler.jar --js=src/main/bulletml.js --js=src/main/bulletml.enchant.js --js_output_file=target/bulletml-join-$2.min.js
